...
<nav x-data="{ open: false }" class="bg-primary dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700" style="background-color:slateblue">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" style="font-color:white">
                    ...
                    <x-nav-link :href="route('table')" :active="request()->routeIs('table')" class="nav-link">
                        {{ __('Таблицы') }}
                    </x-nav-link>
                </div>
            </div>
