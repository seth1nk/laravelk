    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="admin_panel" class="brand-link">
                <img src="/admin/dist/img/favicon.ico" alt="AdminLTE Logo"
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('category.index') }}" class="nav-link">
                                        <p>Все диспетчерские</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('category.create') }}" class="nav-link">
                                        <p>Добавить диспетчерскую</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
    ...
    <script>
        $(document).ready(function () {
            $('[data-widget="pushmenu"]').click(function () {
                // Используем встроенную функцию AdminLTE для управления боковой панелью
