<x-app-layout>
    ...
    <div class="container mt-5">
        <form action="{{ route('voditeli.store') }}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="name_vod" class="form-label">ФИО Водителя</label>
                <input type="text" class="form-control" id="name_vod" name="name_vod" required>
            </div>
            <div class="mb-3">
                <label for="stazh" class="form-label">Стаж</label>
                <input type="text" class="form-control" id="stazh" name="stazh" required>
            </div>
            <div class="mb-3">
                <label for="number_pass" class="form-label">№ паспорта</label>
                <input type="text" class="form-control" id="number_pass" name="number_pass" required>
            </div>
            <div class="mb-3">
