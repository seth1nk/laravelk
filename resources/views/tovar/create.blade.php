    ...
    <div class="container mt-5">
        <form action="{{ route('tovar.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_tovar" name="name_tovar" required>
            </div>
            <div class="mb-3">
                <label for="kolvo_tovar" class="form-label">Количество товара</label>
                <input type="text" class="form-control" id="kolvo_tovar" name="kolvo_tovar" required>
            </div>
            <div class="mb-3">
                <label for="cena_tovar" class="form-label">Цена товара</label>
                <input type="text" class="form-control" id="cena_tovar" name="cena_tovar" required>
            </div>
