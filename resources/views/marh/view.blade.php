<x-app-layout>
    ...
    <div class="container mt-5">
        <p><strong>ID:</strong> {{ $marh->id_marh }}</p>
        <p><strong>Пункт назначения:</strong> {{ $marh->mesto }}</p>
        <p><strong>Расстояние до пункта назначения,км:</strong> {{ $marh->rasstoyanie }}</p>
    </div>
    <br>
    <div align="center"><a href="{{ route('marh.index') }}" class="btn btn-success">Вернуться</a></div>
</x-app-layout>